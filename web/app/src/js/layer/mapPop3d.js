...
define(function (require) {
    ...
    var BIGraphyPop = require('mod/biGraphy/biGraphy3d');
    var ContainerJobList = require('mod/containerJobList/containerJobList3d');
        ...
        showPop: function (type, args) {
            ...
            switch (type) {
                ...
                case 'boatBayDetail':
                    ...
                    pop.getBoatBayDetailByParam(args.vesselCode, args.bay);
                    break;
                case 'boxDetail':
                    this.hidePop();
                    var pop = CenterPopup({
