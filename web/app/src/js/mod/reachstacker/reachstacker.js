/**
 * @module port/mod/REACHSTACKER 正面吊
 */
define(function (require) {
    ...
    var imageUrl = '../../src/js/mod/reachstacker/images/icon-triangle-active.png';
    ...
    REACHSTACKER.prototype = $.extend(new McBase(), {
        ...
        draw: function () {
            ...
            scaleRatio < this.maxShowScale ? hightLightRadius = 10 : hightLightRadius = 10;
            ...
            (this.scaleLevel > this.edgeScaleLevel && this.isShowQuota && this.workStatus === 'WORK') && (group.add(reachstackerText));
            /* 构建进度条 */
        ...
        getImageUrl: function () {
            ...
            imageUrl = '../../src/js/mod/reachstacker/images/' + scaleRatioFolder + '/icon-' + iconType + '.png';
            return imageUrl;
        },
