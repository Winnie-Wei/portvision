/**
 * @module mod/hydrant/hydrant 消防栓
 */
define(function (require) {
    ...
    var imageUrl = '../../src/js/mod/hydrant/images/min/icon-hydrant.png';

    var HYDRANT = function (cfg) {
        if (!(this instanceof HYDRANT)) {
            return new HYDRANT().init(cfg);
        }
    };

    HYDRANT.prototype = $.extend(new McBase(), {
        /**
         * desc: 初始化对象
         * @return HYDRANT
         */
        ...
        getImageUrl: function () {
            ...
            if (this.scaleRatio < 2) {
                ...
                this.imagePoint = { x: 6, y: 8 };
            } else {
                scaleRatioFolder = 'max';
                this.imagePoint = { x: 6, y: 8 };
            }

            imageUrl = '../../src/js/mod/hydrant/images/' + scaleRatioFolder + '/icon-hydrant.png';
